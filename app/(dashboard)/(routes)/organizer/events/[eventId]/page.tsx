...
const EventIdPage = async ({ params }: { params: { eventId: string } }) => {
    ...
    return (
        <>
            {!Event.isPublished && (
                <Banner variant={"warning"} label="This event is not published. It will not be visible to the public." />
            )}
            <div className="p-6">
                <div className="flex items-center justify-between">
                    ...
                    <EventActions disabled={completedFields !== totalField} eventId={ (await params).eventId } isPublished={Event.isPublished} />
                </div>
